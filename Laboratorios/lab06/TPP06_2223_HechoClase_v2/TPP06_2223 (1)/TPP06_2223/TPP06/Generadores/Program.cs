...
namespace Generadores
{
    public static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var imparesEstricto = Funciones.ImparesGeneradorEstricto(desde, cantidad); // Aqui ya se esta generando la lista de impares
            ...
            imparesLazy.ForEach( item => Console.Write("{0} ", item) , mostrarNElementos); // Aqui hasta que no se utiliza la secuencia no se genera y se genera cuando se llega al desde 
