...
namespace Tests
{
    ...
    public class Prueba
    {
        Lista<int> listaPequeña = new Lista<int>();
        Lista<int> listaGrande = new Lista<int>();
        Lista<char> listaChar = new Lista<char>();
        Lista<double> listaDouble = new Lista<double>();
        Lista<string> listaString = new Lista<string>();
        Lista<object> listaMiscelanea = new Lista<object>();
        Lista<object> listaNull = new Lista<object>();
        ...
        public void TestNull()
        {
            ...
            Assert.AreEqual("[ -  -  -  -  - ]", listaNull.ToString());
            ...
            // Comprobar exactamente que nuestro toString muestra los null
            Assert.AreEqual("[a -  - 1 -  -  -  -  - a - ]", listaNull.ToString());
            ...
            // Comprobar exactamente que nuestro toString muestra los null
            Assert.AreEqual("[a - 1 -  -  -  - ]", listaNull.ToString());
